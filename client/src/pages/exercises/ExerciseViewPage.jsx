...
function ExerciseViewPage() {
  ...
  const { getExerciseToUpdate, toUpdate, deleteExercise } = useExercise()
  const { id } = useParams()
        ...
        <div className='routine-container'>
          <div className='title-box'>
            <div className='title-section'>
              ...
              <h1 className='page-title'>{toUpdate.name}</h1>
            </div>
            {toUpdate.isCustom && (
              <div className='menu-container'>
                ...
                <div className={`menu-display-mobile ${isActive ? 'active' : 'inactive'}`}>
                  ...
                  <div className='content'>
                    <Link className='menu-option' to={`/edit-exercise/${toUpdate._id}`}>
